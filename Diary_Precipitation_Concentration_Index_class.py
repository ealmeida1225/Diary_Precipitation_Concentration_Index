...
with pd.ExcelWriter('output aXexp(bX).xlsx') as writer:
    for month in range(12):
        file_route = 'Para artículo por meses-sin null\mes ' + str(month + 1)
        ...
        resume_df = resume_df.append(pd.DataFrame([[
            ...
            round(ci_calculator.std_dev, 2), #Desviación estándar
